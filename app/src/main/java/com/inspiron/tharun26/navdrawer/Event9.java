...
public class Event9 extends ActionBarActivity  implements FlipAdapterEvent9.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent9 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view9);
        mAdapter = new FlipAdapterEvent9(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view9));
