...
public class Event8 extends ActionBarActivity  implements FlipAdapterEvent8.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent8 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view8);
        mAdapter = new FlipAdapterEvent8(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view8));
