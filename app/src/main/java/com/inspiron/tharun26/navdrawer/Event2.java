...
public class Event2 extends ActionBarActivity  implements FlipAdapterEvent2.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent2 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view2);
        mAdapter = new FlipAdapterEvent2(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view2));
