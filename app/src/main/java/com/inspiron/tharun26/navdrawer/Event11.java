...
public class Event11 extends ActionBarActivity  implements FlipAdapterEvent11.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent11 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view11);
        mAdapter = new FlipAdapterEvent11(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view11));
