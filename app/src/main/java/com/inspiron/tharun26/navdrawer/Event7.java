...
public class Event7 extends ActionBarActivity  implements FlipAdapterEvent7.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent7 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view7);
        mAdapter = new FlipAdapterEvent7(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view7));
