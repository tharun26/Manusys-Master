 ...
 */
public class FlipAdapterEvent8 extends BaseAdapter implements ImageView.OnClickListener {
   ...
   /* static class Item {
    ...
    public FlipAdapterEvent8(Context context,ArrayList<EventInformation> eventInformation) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position==0)
        {
            ...
            convertView = mInflater.inflate(R.layout.page_event8_intro, null);
        }
        else if(position==1 ) {
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event8_rules, null);
           /* ImageView imgIcon = (ImageView) convertView.findViewById(R.id.imageView);
            ...
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event8_venue, null);
            ImageView event1_venue=(ImageView)convertView.findViewById(R.id.venue_event8);
         ...
         /*   ImageView imgIcon = (ImageView) convertView.findViewById(R.id.imageView);
            ...
            */
            ...
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event8_contact, null);
            ImageView contact1_event_1=(ImageView)convertView.findViewById(R.id.contact1_event_8);
