...
public class Event5 extends ActionBarActivity  implements FlipAdapterEvent5.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent5 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view5);
        mAdapter = new FlipAdapterEvent5(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view5));
