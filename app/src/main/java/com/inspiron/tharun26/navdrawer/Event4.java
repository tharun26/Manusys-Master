...
public class Event4 extends ActionBarActivity  implements FlipAdapterEvent4.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent4 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view4);
        mAdapter = new FlipAdapterEvent4(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view4));
