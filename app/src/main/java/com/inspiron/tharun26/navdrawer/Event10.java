...
public class Event10 extends ActionBarActivity  implements FlipAdapterEvent10.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent10 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view10);
        mAdapter = new FlipAdapterEvent10(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view10));
