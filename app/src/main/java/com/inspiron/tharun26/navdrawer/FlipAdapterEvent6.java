 ...
 */
public class FlipAdapterEvent6 extends BaseAdapter implements ImageView.OnClickListener {
   ...
   /* static class Item {
    ...
    public FlipAdapterEvent6(Context context,ArrayList<EventInformation> eventInformation) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position==0)
        {
            ...
            convertView = mInflater.inflate(R.layout.page_event6_intro, null);
        }
        else if(position==1 ) {
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event6_rules, null);
           /* ImageView imgIcon = (ImageView) convertView.findViewById(R.id.imageView);
            ...
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event6_venue, null);
            ImageView event1_venue=(ImageView)convertView.findViewById(R.id.venue_event6);
         ...
         /*   ImageView imgIcon = (ImageView) convertView.findViewById(R.id.imageView);
            ...
            */
            ...
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event6_contact, null);
            ImageView contact1_event_1=(ImageView)convertView.findViewById(R.id.contact1_event_6);
