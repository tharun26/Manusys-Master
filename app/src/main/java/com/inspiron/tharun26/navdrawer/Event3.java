...
public class Event3 extends ActionBarActivity  implements FlipAdapterEvent3.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent3 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view3);
        mAdapter = new FlipAdapterEvent3(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view3));
