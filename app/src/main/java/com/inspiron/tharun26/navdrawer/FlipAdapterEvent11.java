 ...
 */
public class FlipAdapterEvent11 extends BaseAdapter implements ImageView.OnClickListener {
   ...
   /* static class Item {
    ...
    public FlipAdapterEvent11(Context context,ArrayList<EventInformation> eventInformation) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position==0)
        {
            ...
            convertView = mInflater.inflate(R.layout.page_event11_intro, null);
        }
        else if(position==1 ) {
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event11_rules, null);
           /* ImageView imgIcon = (ImageView) convertView.findViewById(R.id.imageView);
            ...
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event11_venue, null);
            ImageView event1_venue=(ImageView)convertView.findViewById(R.id.venue_event11);
         ...
         /*   ImageView imgIcon = (ImageView) convertView.findViewById(R.id.imageView);
            ...
            */
            ...
            LayoutInflater mInflater = (LayoutInflater)
                    context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = mInflater.inflate(R.layout.page_event11_contact, null);
            ImageView contact1_event_1=(ImageView)convertView.findViewById(R.id.contact1_event_11);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.venue_event11:
                ...
                break;
            case R.id.contact1_event_11:
                Intent intent1 = new Intent(Intent.ACTION_DIAL);
                intent1.setData(Uri.parse("tel:960016981"));
