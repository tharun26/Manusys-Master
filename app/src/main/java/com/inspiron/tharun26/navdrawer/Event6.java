...
public class Event6 extends ActionBarActivity  implements FlipAdapterEvent6.Callback, FlipView.OnFlipListener, FlipView.OnOverFlipListener {

    private FlipView mFlipView;
    private FlipAdapterEvent6 mAdapter;
...
//        eventInformations.add(new EventInformation(event_titles[4], event_icons.getResourceId(4, -1)));
        ...
        mFlipView = (FlipView) findViewById(R.id.flip_view6);
        mAdapter = new FlipAdapterEvent6(this,eventInformations);
        ...
        mFlipView.setEmptyView(findViewById(R.id.empty_view6));
